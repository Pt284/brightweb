...
# 4. Replace buildTree
oldBuildTreeStart = "// ── RENDER: TREE ──"
oldBuildTreeEnd = "// ── PHASE 2: Edit Mode ──"

startIndex = html.find(oldBuildTreeStart)
endIndex = html.find(oldBuildTreeEnd)

if startIndex == -1 or endIndex == -1:
    print("Could not find buildTree bounds")
    sys.exit(1)

newBuildTree = """// ── RENDER: TREE ──
...
html = html[:startIndex] + newBuildTree + html[endIndex + len(oldBuildTreeEnd):]

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('Patched index.html with Python script')
